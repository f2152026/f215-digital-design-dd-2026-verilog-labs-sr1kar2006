...
module cla4(
  ...
  wire t_c2a, t_c2b;
  and #(2) (t_c2a, p1, g0);
  and #(2) (t_c2b, p1, p0, cin);
  or  #(2) (c2,    g1, t_c2a, t_c2b);

  // c3 = g2 | p2.g1 | p2.p1.g0 | p2.p1.p0.cin
  wire t_c3a, t_c3b, t_c3c;
  and #(2) (t_c3a, p2, g1);
  and #(2) (t_c3b, p2, p1, g0);
  and #(2) (t_c3c, p2, p1, p0, cin);
  or  #(2) (c3,    g2, t_c3a, t_c3b, t_c3c);

  // c4 (cout) = g3 | p3.g2 | p3.p2.g1 | p3.p2.p1.g0 | p3.p2.p1.p0.cin
  wire t_c4a, t_c4b, t_c4c, t_c4d;
  and #(2) (t_c4a, p3, g2);
  and #(2) (t_c4b, p3, p2, g1);
  and #(2) (t_c4c, p3, p2, p1, g0);
  and #(2) (t_c4d, p3, p2, p1, p0, cin);
  or  #(2) (cout,  g3, t_c4a, t_c4b, t_c4c, t_c4d);

  // ---- Step 3: sum bits  (sum[i] = p[i] ^ c[i], c[0] = cin) ----
  xor #(2) (sum[0], p0, cin);
  xor #(2) (sum[1], p1, c1);
  xor #(2) (sum[2], p2, c2);
  xor #(2) (sum[3], p3, c3);
